...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/cpen.css">
...
<body>
    <div class="after_q_submit">
<div class="after_q_submit_result"><span class="close_after_q_submit">&times;</span></div>
</div>
...
<div class="row">
	...
	<div class="col-md-12">
		<?php  include 'includes/cpenal.php'; ?>
	</div>
</div></div>
